export default {
  ...
  tenants: {
    ...
    samlApps: { metaTitle: "SAMLアプリケーション - {{tenantName}} - Auth9", title: "{{tenantName}}のSAMLアプリケーション", description: "Auth9をIdPとして外部サービスプロバイダーのSAML SSOを登録します。", createTitle: "SAMLアプリケーション登録", createDescription: "外部サービスプロバイダーをAuth9のSAML IdPとして設定します。", name: "アプリケーション名", namePlaceholder: "Salesforce SSO", entityId: "Entity ID (SP)", entityIdPlaceholder: "https://sp.example.com/saml/metadata", acsUrl: "ACS URL", acsUrlPlaceholder: "https://sp.example.com/saml/acs", sloUrl: "SLO URL（任意）", sloUrlPlaceholder: "https://sp.example.com/saml/slo", nameIdFormat: "NameIDフォーマット", nameIdFormats: { email: "メール", persistent: "永続", transient: "一時", unspecified: "未指定" }, signAssertions: "アサーション署名", signResponses: "レスポンス署名", encryptAssertions: "アサーション暗号化", spCertificate: "SP証明書（PEM）", spCertificatePlaceholder: "-----BEGIN CERTIFICATE-----...", attributeMappings: "属性マッピング", attributeSource: "ソース", samlAttribute: "SAML属性", friendlyName: "フレンドリー名", addMapping: "マッピング追加", createApp: "アプリケーション登録", configuredTitle: "登録済みSAMLアプリケーション", configuredDescription: "設定済みのサービスプロバイダー連携を管理します。", noApps: "SAMLアプリケーションが登録されていません。", metadataUrl: "IdP Metadata URL", ssoUrl: "SSO URL", appCreated: "SAMLアプリケーションを登録しました", appDeleted: "SAMLアプリケーションを削除しました", appUpdated: "SAMLアプリケーションを更新しました" },
